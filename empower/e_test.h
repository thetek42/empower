...
void e_test__assert_mem_eq(const char *msg, const char *location, const char *expr, const void *got,
                           const void *want, size_t len);

void e_test__assert_ptr_eq(const char *msg, const char *location, const char *expr, const void *got,
                           const void *want);

void e_test__assert_null(const char *msg, const char *location, const char *expr, const void *ptr);

void e_test__assert_str_eq(const char *msg, const char *location, const char *expr, const char *got,
                           const char *want);

void e_test__assert_ptr_aligned(const char *msg, const char *location, const char *expr,
                                const void *got, size_t alignment);
