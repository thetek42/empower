...
/**
 * Convert uppercase ASCII characters the nul-terminated string `src` to lowercase and store them in
...
/**
 * Find the character `c` in the nul-terminated string `s`. If no match is found within the string,
...
/**
 * Find the first character in the nul-terminated string `s` which is also contained in the
...
/**
 * Find the first character in the nul-terminated string `s` which is not contained in the
...
/**
 * Find the first character in the nul-terminated string `s` which matches the predicate `func`. If
...
/**
 * Find the first character in the nul-terminated string `s` which is rejected by the predicate
...
/**
 * Find the substring `needle` in the nul-terminated string `haystack`. If no match is found within
...
/**
 * Find the character `c` in the nul-terminated string `s` starting from the end of the string. If
 * no match is found within the string, NULL is returned. Otherwise, a pointer to the matched
...
/**
 * Find the last character in the nul-terminated string `s` which is also contained in the
 * nul-terminated string `accept`. If no match is found within the string, NULL is returned.
 * Otherwise, a pointer to the matched character is returned.
 */
const char *
...
/**
 * Find the last character in the nul-terminated string `s` which is not contained in the
 * nul-terminated string `reject`. If no match is found within the string, NULL is returned.
 * Otherwise, a pointer to the matched character is returned.
 */
const char *
...
/**
 * Find the last character in the nul-terminated string `s` which matches the predicate `func`. If
 * no match is found within the string, NULL is returned. Otherwise, a pointer to the matched
 * character is returned.
 */
const char *
...
/**
 * Find the last character in the nul-terminated string `s` which is rejected by the predicate
 * `func`. If no match is found within the string, NULL is returned. Otherwise, a pointer to the
 * matched character is returned.
 */
const char *
...
/**
 * Checks if two strings `a` and `b` are equal. If both `a` and `b` are NULL, or the strings are
...
/**
 * Checks if two strings `a` and `b` are equal in the first `n` bytes. If both `a` and `b` are NULL,
...
/**
 * Trim whitespace from the start of the nul-terminated string `s`. Returns a pointer to the start
...
/**
 * Trim whitespace at the start and end of the nul-terminated string `s`. Returns a pointer to the
...
/*
 * Trim whitespace at the start and end of the nul-terminated string `s` of length `len`. `len` must
 * be equal to `strlen (s)`. Returns a pointer to the start of the trimmed string. `len` will be set
...
/**
 * Calculate the Levenshtein distance (i.e. the number of simple edits to transform one string into
