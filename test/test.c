...
test_cstr (void)
{
	...
	e_test_assert_eq ("e_cstr_count_char_matching", e_cstr_count_char_matching (s1, islower), 8);
	e_test_assert_eq ("e_cstr_count_str", e_cstr_count_str (s4, "en"), 3);
	e_test_assert_eq ("e_cstr_count_str too long", e_cstr_count_str (s3, "123456"), 0);
	...
	e_test_assert_eq ("e_cstr_find_char existant", (void *) e_cstr_find_char (s1, 'o'), s1 + 4);
	e_test_assert_eq ("e_cstr_find_char nonexistant", (void *) e_cstr_find_char (s1, 'u'), nullptr);
	e_test_assert_eq ("e_cstr_find_char_matching existant", (void *) e_cstr_find_char_matching (s5, isalpha), s5 + 2);
	e_test_assert_eq ("e_cstr_find_char_matching nonexistant", (void *) e_cstr_find_char_matching (s5, isdigit), nullptr);
	e_test_assert_eq ("e_cstr_find_str existant", (void *) e_cstr_find_str (s4, "en"), s4 + 3);
	e_test_assert_eq ("e_cstr_find_str nonexistant", (void *) e_cstr_find_str (s5, "es"), nullptr);
	e_test_assert_eq ("e_cstr_eq null null", e_cstr_eq (nullptr, nullptr), true);
	e_test_assert_eq ("e_cstr_eq ptr null", e_cstr_eq (s5, nullptr), false);
	e_test_assert_eq ("e_cstr_eq ptr eq ptr", e_cstr_eq (s5, s5), true);
	e_test_assert_eq ("e_cstr_eq eq", e_cstr_eq (s5, s7), true);
	e_test_assert_eq ("e_cstr_eq not eq", e_cstr_eq (s5, s4), false);
